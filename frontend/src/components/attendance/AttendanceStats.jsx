import { CheckCircle2, Clock, XCircle, Users, FileCheck2, HeartPulse, Circle } from 'lucide-react';
import Card from '../ui/Card';

const ICONS = { present: CheckCircle2, late: Clock, absent: XCircle, excused: FileCheck2, sick: HeartPulse, not_yet: Circle, total: Users };
const TONE_CLASS = {
      ...
      {items.map((item) => {
        ...
        return (
          ...
          >
            ...
            <p className="text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-100">{item.value}</p>
