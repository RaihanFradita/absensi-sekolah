          ...
          <div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Card className="flex items-center gap-4">
                <div
                  className={`flex h-11 w-11 items-center justify-center rounded-full ${todayStatus ? "bg-emerald-50 text-emerald-600 dark:bg-emerald-950 dark:text-emerald-400" : "bg-slate-100 text-slate-500 dark:bg-slate-800"}`}
                >
                  {todayStatus ? (
                ...
                <div>
                  ...
                  {data.today?.scannedAt && (
                    <p className="mt-1 text-xs text-slate-500">
                      Scan {formatTimeShort(data.today.scannedAt)}
                    </p>
                  )}
                </div>
              </Card>
